...
public class Coc {
    ...
    private void initItemTextures()
    {
        ...
        Texture n_i = new Texture();
        try {
            n_i.loadFromFile(Paths.get("Assets/graphics/items/no_item.png"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        itemtextures.put("no_item",n_i);
    }
    private void initBuildingTextures()
    {
        ...
        try {
            mine.loadFromFile(Paths.get("Assets/graphics/buildings/mine.png"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        buildingtextures.put("mine",mine);
    }
}
