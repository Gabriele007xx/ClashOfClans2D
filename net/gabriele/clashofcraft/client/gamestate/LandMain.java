...
import net.gabriele.clashofcraft.client.core.Timer;
...
public class LandMain extends State{
    ...
    public static int NUMBER_OF_BUILDERS = 1;
    public static int CURRENT_BUILDER = 1;
    ...
    public LandMain()
    {
        ...
        Mine mine = new Mine(Coc.buildingtextures.get("mine"),640,280);
        buildings.add(mine);
        Timer.clock.restart();
    }
